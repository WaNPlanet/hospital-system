				...
				<h2 class="title">Welcome</h2>
           		...
           		<div class="input-div pass">
           		   ...
           		   <div class="div">
						   ...
						   name="sadmpw" required="required">
            	   </div>
            	</div>
				<a href="signup.php"> Sign up</a>
            	<input name="login" onclick="chcke();"  type="submit" value="SUBMIT" class="btn ">
			...
			<form method="post">
				...
				<h2 class="title">Welcome</h2>
           		...
           		<div class="input-div pass">
           		   ...
           		   <div class="div">
           		    	<h5>Password</h5>
           		    	<input type="password" class="input" name="sadmpw" required="required" >
            	   </div>
            	</div>
            	<!-- <a href="#">Forgot Password?</a> -->
					<a href="signup.php"> Sign up</a>
