...
<div class="container-fluid">
    <div class="row">
            <ul class="nav" style="background-color:#FFF;">
                <li class=" col" style="font-family:calibri; font-size:16px;">
                    <a style="color:#000" href="invoinfo.php"><strong>OPD Patients Invoiceses</strong></a>
                </li>
                <li class=" col" style="font-family:calibri; font-size:16px;">
                    <a style="color:#000" href="invoadinfo.php"><strong>Admited Patients Invoiceses</strong></a>
                </li>
            </ul>
