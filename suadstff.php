...
<h1 class="heading"> <span>Update Staff  </span>Member Information </h1>    
...
<div class="row">
      ...
      <h4 class="text-center">Enable Fields using active field dropdown</h4>
   <h1 class="heading"><a href="supadminopsm.php">Go Back!</a></h1>   
      </div>
      </div>
      </div>
<?php
...
<div style="padding:20px;  margin:5px; border-radius:5px; 
      background-color:rgba(255, 255, 255, 0.3);"class="col-md-4 col-md-push-4">
      ...
      <dl>
        ...
        <dd style="font-size:12px;">
        <select onchange="display()"  style="margin:5px; border-colour=red;" 
        id="fieldsac" required="required"  class="form-control" placeholder="Select your Staff Type">
