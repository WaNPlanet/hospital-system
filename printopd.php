...
<h1 class="text-center ">E-Health GH<br /><small style="font-size:20px">Patient Invoice</small></h1></div>
</div>
</div>
...
<form class="" action="" method="post" id="upform">
  ...
  <table height="500" width="500">
    ...
    <tr>
      ...
      <td width="250"><strong>$. <?php echo $row["medi_charge"]; ?>.00</strong></td>
    </tr>
    <tr>
      <td width="200"><strong>Price for Docto$ : </strong></td>
      <td width="250"><strong>$. <?php echo $row["doc_charge"]; ?>.00</strong></td>


    <tr>
      <td ><strong>Service Charge : </strong></td>
      <td ><strong>$. <?php echo $row["hos_charge"]; ?>.00</strong></td>
    </tr>
    <tr>
      <td ><strong>Tolat Price : </strong></td>
      <td ><strong>$. <?php echo $row["total_charge"]; ?>.00</strong></td>
    </tr>
  </table>
<br>
