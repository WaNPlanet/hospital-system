           ...
           <nav class="main-menu">
              ...
              <div id="navbar" class="navbar-collapse collapse">
                 <ul class="nav navbar-nav">
                    ...
                    <li><a class="active" data-scroll href="invoinfo.php">All OPD Patients Invoiceses</a></li>
                    <li><a data-scroll href="invoadinfo.php">All Admited Patients Invoiceses</a></li>
...
<h1 class="heading"> <span>All OPD</span> Patients Invoiceses </h1>    
