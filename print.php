...
<h1 class="text-center ">Health Care Hospital<br />
<small style="font-size:20px">Patient Invoice</small></h1></div>
</div>
</div>

<center>
<form class="book" action="" method="post" id="upform">
  ...
  <table height="500" width="500">
    ...
    <tr>
      ...
      <td width="250"><strong>$. <?php echo $row["price_of_med"]; ?>.00</strong></td>
    </tr>
    <tr>
      <td width="200"><strong>Price for Docto$ : </strong></td>
      <td width="250"><strong>$. <?php echo $row["price_of_doc"]; ?>.00</strong></td>
    </tr>
    ...
    <tr>
      <td >Price Per 1 room $.1000.00<br><strong>Price for Room : </strong></td>
      <td ><strong>$. <?php echo $row["price_of_doc"]; ?>.00</strong></td>
    </tr>
    <tr>
      <td ><strong>Service Charge : </strong></td>
      <td ><strong>$. <?php echo $row["ser_char"]; ?>.00</strong></td>
    </tr>
    <tr>
      <td ><strong>Tolat Price : </strong></td>
      <td ><strong>$. <?php echo $row["totl"]; ?>.00</strong></td>
    </tr>
  </table>
<br>

<button   class="hidden-print btn" name=submit type="button" onclick="formPrint()">Print</button>
</center>
  </ul>
